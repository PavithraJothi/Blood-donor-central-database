...
ps = conn.prepareStatement("insert into bloodbank values (?,?,?,?,?,?,?)");
...
ps.executeUpdate();
//response.sendRedirect("sendemail.html");
out.println("<center><h3>SUCCESSFULLY REGISTERED!!!</h3><br><br><a href='Bloodbanklogin.html'><b>GO BACK</b></a></center>");
